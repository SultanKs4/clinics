...
<body>
    ...
    <div class="container-fluid" style="">
        ...
        <form action="home.php" method="GET">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputFullName1" aria-describedby="fullnameHelp" placeholder="Masukkan Nama Lengkap" required>
    ...
    <!-- Footer -->
    <footer style="background-color: rgb(21, 211, 155); height: 40px;" class="navbar navbar-expand-lg my-auto text-center">
