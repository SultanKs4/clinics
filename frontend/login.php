...
<body>
    ...
    <nav style="background-color: rgb(21, 211, 155);" class="navbar navbar-expand-lg">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div id="link_login" style="padding-left: 40px;font-family: 'Monteserrat';">
                <a class="btn btn-success" href="register.php">Register</a> | <a href="index.html" class="btn btn-outline-danger">Back</a>
            </div>
        </div>
    </nav>
    <!-- Bagian Form -->
    <div class="container-fluid" style="">
        ...
        <form action="home.php" method="GET">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputUsername1" aria-describedby="usernameHelp" placeholder="Masukkan username" required>
    ...
    <!-- Footer -->
    <footer style="background-color: rgb(21, 211, 155); height: 40px;" class="navbar navbar-expand-lg my-auto text-center fixed-bottom">
